...
// Component show modal of active card
function ActiveCard() {
  ...
  // Function call api to update card
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={9}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              {/* Feature 04: Card's activity (comment on card) */}
              <CardActivitySection
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              {/* Feature 05: add user to active card */}
              ...
              {activeCard?.memberIds?.includes(currentUser._id)
                ...
                >
                  <PersonOutlineOutlinedIcon fontSize="small" /> Join
                </SidebarItem>
              }
              {/* Feature 06: update card cover */}
