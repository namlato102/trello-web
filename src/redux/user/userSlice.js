...
export const loginUserAPI = createAsyncThunk(
  'user/loginUserAPI',
  async (data) => {
    const response = await authorizedAxiosInstance.post(`${API_URL}/v1/users/login`, data)
...
export const logoutUserAPI = createAsyncThunk(
  ...
  async (showSuccessMessage = true) => {
    const response = await authorizedAxiosInstance.delete(`${API_URL}/v1/users/logout`)
...
export const updateUserAPI = createAsyncThunk(
  'user/updateUserAPI',
  async (data) => {
    const response = await authorizedAxiosInstance.put(`${API_URL}/v1/users/update`, data)
    return response.data
  }
)
